...
--DLL TEST
--sequence 생성
create sequence seq_pbasic_idx; -- 이렇게만 해도 생성은 된다.
...
insert into phoneInfo_basic (IDX , FR_NAME , FR_PHONENUMBER  , FR_EMAIL , FR_ADDRESS )
                     values (seq_pbasic_idx.nextval , '박효신'   , '010-5478-6321' , 'bark@gmail.com' , '서울' );
insert into phoneInfo_basic (IDX , FR_NAME , FR_PHONENUMBER , FR_EMAIL , FR_ADDRESS , FR_REGDATE)
                     values (seq_pbasic_idx.nextval , '성시경' , '010-5471-9618' , 'sung@gmail.com' , '경기도' , '');
insert into phoneInfo_basic values (seq_pbasic_idx.nextval , '싸이' , '010-5471-9618' , 'ssa@gmail.com' , '경기도' , '');
...
insert into phoneinfo_univ (IDX , FR_U_MAJOR , FR_U_YEAR , FR_U_REF)
                     values (seq_univ_idx.nextval , '발라드' , 4 , seq_pbasic_idx.currval);
...
insert into phoneinfo_com (IDX , FR_C_COMPANY , FR_REF)
                     values (seq_com_idx.nextval , '버블스튜디오' , seq_pbasic_idx.currval);
